...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Thúy - Trường Tiểu học Hùng An- ĐT: 036 6115 901</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Thúy- Trường Tiểu học Hùng An - ĐT: 036 6115 901</div>", unsafe_allow_html=True)
